  ...
  render() {
    return (
      <div className="measure-wide center tl bg-near-white b--near-black pa4 br4 lh-copy">
        ...
        <p>
          Go ahead and change some text in the right form.
          Notice how it updates in{' '}
          {this.props.updatedYet ? <strong>4</strong> : 3} different
          places?
        </p>
        {this.props.updatedYet
          ? <p>
              ...
              <ul>
                ...
                <li>to <strong>{this.props.header.text}</strong></li>
              </ul>
            </p>
